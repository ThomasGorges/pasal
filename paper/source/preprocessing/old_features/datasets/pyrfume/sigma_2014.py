...
molecules = pd.read_csv("../../../../data/old_features/pyrfume/sigma_2014/molecules.csv")
behavior = pd.read_csv("../../../../data/old_features/pyrfume/sigma_2014/behavior_sparse.csv")
...
new_df.to_json("../../../../output/old_features/data/pyrfume/sigma_2014.json", indent=4)
